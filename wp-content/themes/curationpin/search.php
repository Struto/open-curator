...
get_header(); ?>
		...
		<section id="primary" class="site-content">
			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'curationpin' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
				</header>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<?php if ( has_post_thumbnail() ) { ?>			
                ...
                <p class="curationpin-date"><?php the_time(get_option('date_format')); ?>  </p>
