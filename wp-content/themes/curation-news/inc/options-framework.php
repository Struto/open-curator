...
function optionsframework_load_sanitization() {
	require_once get_template_directory() . '/inc/options-sanitize.php';
}
...
function optionsframework_init() {
	...
	require_once get_template_directory() . '/inc/options-interface.php';
	require_once get_template_directory() . '/inc/options-media-uploader.php';
...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page( __('Theme Options', 'curationnews'), __('Theme Options', 'curationnews'), 'edit_theme_options', 'options-framework','optionsframework_page' );
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear','curationnews' ),
			'defaultString' => __( 'Default', 'curationnews' ),
			'pick' => __( 'Select Color', 'curationnews' )
		);
...
settings_errors(); ?>
  <h2> &nbsp; &nbsp; <img src="<?php echo get_template_directory_uri();?>/inc/images/curation-news.png" alt="Logo">   &nbsp; &nbsp;
<!-- <a id="support"   title="Support" href="http://curationnews.premiumresponsive.com/support/" target="_blank">Support</a>   &nbsp; &nbsp;  <a id="demo" title="Demo" href="http://pr.premiumresponsive.com/" target="_blank">Demo </a> -->
  </h2>
<hr  style="clear:both;">
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'curationnews' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'curationnews' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'curationnews' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'curationnews' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'curationnews' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Theme Options', 'curationnews' ),
