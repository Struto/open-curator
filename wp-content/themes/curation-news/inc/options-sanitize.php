...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'pr' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'pr' ),
		'repeat-y'  => __( 'Repeat Vertically', 'pr' ),
		'repeat'    => __( 'Repeat All', 'pr' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'pr' ),
		'top center'    => __( 'Top Center', 'pr' ),
		'top right'     => __( 'Top Right', 'pr' ),
		'center left'   => __( 'Middle Left', 'pr' ),
		'center center' => __( 'Middle Center', 'pr' ),
		'center right'  => __( 'Middle Right', 'pr' ),
		'bottom left'   => __( 'Bottom Left', 'pr' ),
		'bottom center' => __( 'Bottom Center', 'pr' ),
		'bottom right'  => __( 'Bottom Right', 'pr')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'pr' ),
		'fixed'  => __( 'Fixed in Place', 'pr')
		);
