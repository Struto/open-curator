				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="copyright">
							...
							<?php else: ?>
								<p><?php bloginfo(); ?> &copy; <?php echo date( 'Y' ); ?>. <?php _e( 'All Rights Reserved.', 'curation-hue' ); ?></p>
							<?php endif; ?>
						</div><!--/#copyright-->
						
						<?php if ( !ot_get_option( 'credit' ) ): ?>
						<div id="credit">
							<p><?php _e('Theme by','curation-hue'); ?> <a href="http://curationtraffic.com" rel="nofollow">Curation Hue from Curation Traffic</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
