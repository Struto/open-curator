        ...
        array(
          ...
          'content'   => '
			...
			<ul>
				...
				<li>Download the Hueman sample child theme <a href="https://github.com/AlxMedia/curation-hue-child/archive/master.zip">here</a>.</li>
			</ul>
...
/* ------------------------------------ */
	'settings'        => array(
		...
		array(
			'id'		=> 'header-ad',
			'label'		=> 'Header Banner Ad Code',
			'desc'		=> 'Place your banner ad  image or banner code.',
			'type'		=> 'textarea-simple',
			'section'	=> 'header',
			'rows'		=> '3'
		),
