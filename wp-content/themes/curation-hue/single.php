...
<section class="content">
	...
	<div class="pad group">
		...
		<?php while ( have_posts() ): the_post(); ?>
			<article <?php post_class(); ?>>	
				<div class="post-inner group">
					...
					<p class="post-byline"><?php _e('by','curation-hue'); ?> <?php the_author_posts_link(); ?> &middot; <?php if(!$ybi_no_display_date) :  ?><?php the_time(get_option('date_format')); endif; ?></p>
				...
				<?php if ( has_post_thumbnail() ): ?>
					<?php the_post_thumbnail('thumb-medium', array('class' => 'alignleft')); ?>
				<?php endif; ?>

							<?php the_content(); ?>
							<?php wp_link_pages(array('before'=>'<div class="post-pages">'.__('Pages:','curation-hue'),'after'=>'</div>')); ?>
						</div>
		...
		<?php the_tags('<p class="post-tags"><span>'.__('Tags:','curation-hue').'</span> ','','</p>'); ?>
