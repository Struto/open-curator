...
<p class="support_request_w" style="text-align: left;"><a href="<?php echo YBI_SUPPORT_URL; ?>" target="_blank" class="green_button green_button_support"><i class="fa fa-users fa-lg"></i>&nbsp;&nbsp;Create Support Request</a></p>
                ...
                <h3>Members Area:</h3>
                <p>Login to the <a href="http://members.youbrandinc.com" target="_blank">Members Area</a>.</p>
                <ul>
                    <li><a href="http://members.youbrandinc.com/dashboard/curation-traffic-plugin/" target="_blank" title="">Curation Traffic Plugin</a></li>
                    <li><a href="http://members.youbrandinc.com/dashboard/ultimate-call-to-action-plugin/" target="_blank" title="">Ultimate Call to Action</a></li>
                    <li><a href="http://members.youbrandinc.com/dashboard/curation-mastery-training/" target="_blank" title="">Curation Mastery Training</a></li>
